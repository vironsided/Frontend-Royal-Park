...
const translations = {
    ...
    ru: {
        ...
        payment_howto_step2: "Выберите способ оплаты: Royal Park Advance (аванс) или Bank Card с переходом в AzeriCard.",
        payment_howto_step3: "Проверьте сумму в блоке «Детали оплаты» и нажмите «Оплатить». Далее вы будете перенаправлены на страницу AzeriCard.",
    ...
    az: {
        ...
        payment_howto_step2: "Ödəniş üsulunu seçin: Royal Park Advance (avans) və ya AzeriCard səhifəsinə keçid ilə Bank Card.",
        payment_howto_step3: "«Ödəniş detalları» blokunda məbləği yoxlayın və «Ödə» düyməsinə basın. Sonra AzeriCard səhifəsinə yönləndiriləcəksiniz.",
        payment_method_advance: "Royal Park Advance",
        payment_method_card_portal: "Bank Card",
    ...
    en: {
        ...
        payment_howto_step2: "Choose a method: Royal Park Advance balance or Bank Card with redirect to AzeriCard.",
        payment_howto_step3: "Check the amount in «Payment details» and press «Pay». Then you will be redirected to AzeriCard.",
        payment_method_advance: "Royal Park Advance",
        payment_method_card_portal: "Bank Card",
