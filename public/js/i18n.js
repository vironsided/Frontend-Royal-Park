...
const translations = {
    ...
    ru: {
        ...
        pwsetup_title: "Установка пароля",
        pwsetup_subtitle: "Введите новый пароль для вашего аккаунта",
        pwsetup_login_label: "Логин",
        pwsetup_fullname_label: "ФИО",
        pwsetup_fullname_ph: "Введите ФИО",
        pwsetup_phone_label: "Телефон",
        pwsetup_email_label: "E-mail",
        pwsetup_password_label: "Установите пароль",
        pwsetup_password_ph: "Минимум 6 символов",
        pwsetup_confirm_label: "Повторите новый пароль",
        pwsetup_confirm_ph: "Повторите пароль",
        pwsetup_submit: "Подтвердить",
        pwsetup_processing: "Обработка...",
        pwsetup_err_title: "Ошибка",
        pwsetup_err_no_token: "Отсутствует токен активации",
        pwsetup_back_home: "Вернуться на главную",
        pwsetup_back_login: "Вернуться к входу",
        pwsetup_err_load: "Не удалось получить данные пользователя",
        pwsetup_err_unauth: "Вы не авторизованы",
        pwsetup_denied_title: "Доступ запрещён",
        pwsetup_already_set: "У пользователя с этим логином уже установлен пароль.",
        pwsetup_go_login: "Перейти к входу",
        pwsetup_err_fullname: "Введите ФИО",
        pwsetup_err_phone: "Введите телефон",
        pwsetup_err_email: "Введите email",
        pwsetup_err_password_min: "Пароль должен быть не менее 6 символов",
        ...
        payments_method_card: "Карта",
        payments_method_advance: "Аванс",
        ...
        payments_export_date_from_required: "Для экспорта обязательно выберите дату начала в поле \"От\".",
        ...
        apartment: "Квартира",
        blocks: "Блок",
        invoices_filter_year_placeholder: "Все годы",
        invoices_filter_month_placeholder: "1-12",
        payments_export_title: "Отчет по платежам",
        payments_export_subtitle: "Royal Park - Экспорт для бухгалтерии",
        payments_export_generated: "Сформировано",
        payments_export_filters: "Фильтры",
        payments_export_count: "Количество платежей",
        payments_export_total: "Общая сумма",
        payments_export_services_block_title: "Сводка по услугам",
        payments_export_services_header_service: "Услуга",
        payments_export_services_header_count: "Кол-во платежей",
        payments_export_services_header_amount: "Сумма",
        payments_export_services_no_data: "Нет данных",
        payments_export_details_block_title: "Детализация платежей",
        payments_export_details_date: "Дата",
        payments_export_details_resident: "Резидент",
        payments_export_details_tenant: "Житель",
        payments_export_details_amount: "Сумма",
        payments_export_details_method: "Метод",
        payments_export_details_leftover: "Остаток",
        payments_export_details_reference: "Ссылка",
        payments_export_details_invoice: "Invoice",
        payments_export_details_services_total: "Сумма по услугам",
        payments_export_details_no_data: "Нет данных для экспорта",
        payments_export_filters_resident: "Резидент",
        payments_export_filters_method: "Метод",
        payments_export_filters_period: "Период",
        payments_export_filters_search: "Поиск",
        payments_export_filters_amount: "Сумма",
        payments_export_filters_allocated_only: "Только распределенные платежи",
        payments_export_filters_services: "Услуги",
        invoices_block_label: "Блок (для «по блоку»)",
        invoices_select_block: "— выберите блок —",
        invoices_due_date_label: "Срок оплаты (due date)",
        invoices_due_date_required: "Пожалуйста, выберите срок оплаты.",
        invoices_issue_by_block: "Выставить счёт по блоку",
        invoices_issue_all: "Выставить все счета",
        invoices_issue_all_confirm: "Вы уверены, что хотите выставить все счета?",
        ...
        invoices_export_period_from_required: "Для экспорта обязательно выберите период начала в поле \"Период от\".",
        ...
        open: "Открыть",
        invoices_export_title: "Отчет по счетам",
        invoices_export_subtitle: "Royal Park — Экспорт для учета",
        invoices_export_column_period: "Период",
        invoices_export_column_block: "Блок",
        invoices_export_column_unit: "№ дома",
        invoices_export_column_resident_name: "ФИО жителя",
        invoices_export_column_resident_phone: "Телефон жителя",
        invoices_export_column_resident_code: "Код резидента",
        invoices_export_column_invoice_number: "№ инвойса",
        invoices_export_column_status: "Статус",
        invoices_export_column_amount: "Начислено",
        invoices_export_column_paid: "Оплачено",
        invoices_export_column_remaining: "Остаток",
        invoices_export_column_due_date: "Срок оплаты",
        invoices_export_column_payment_method: "Метод оплаты",
        invoices_export_column_lines: "Состав начисления",
        invoices_export_column_remaining_by_services: "Остаток по услугам",
        invoices_export_usage: "Расход",
        invoices_export_previous_reading: "Предыдущий показатель",
        invoices_export_current_reading: "Показатель на момент инвойса",
        invoices_export_total: "Итого",
        invoices_export_vat: "НДС",
        invoices_export_utilities_net: "Коммунальные (без НДС)",
        invoices_export_utilities_vat: "НДС коммунальных",
        invoices_export_utilities_with_vat: "Коммунальные (с НДС)",
        invoices_export_service_total_label: "Итого",
        invoices_export_count_invoices: "Количество счетов",
        invoices_export_date_from: "ОТ",
        invoices_export_date_to: "ДО",
        invoices_export_stable_tariff_electricity: "Стабильный тариф (Электричество)",
        invoices_export_stable_tariff_gas: "Стабильный тариф (Газ)",
        invoices_export_stable_tariff_water: "Стабильный тариф (Вода)",
        invoices_export_stable_tariff_sewerage: "Стабильный тариф (Канализация)",
        invoices_export_stable_tariff: "Стабильный тариф",
        invoices_export_sewerage: "Канализация",
        ...
        monthly_issue_confirm_title: "Рассылка уведомлений",
        monthly_issue_confirm_message: "Отправить уведомления пользователям по всем выставленным счетам?",
        monthly_issue_confirm_due_date: "Срок оплаты в уведомлении будет: {date} (+{days} дн.)",
        monthly_issue_success: "Уведомления успешно отправлены! Количество: {count}",
        monthly_issue_error_prefix: "Ошибка: {message}",
        ...
        role_sales: "Менеджер продаж",
        role_maintenance: "Служба",
        role_accountant: "Бухгалтер",
        system_admin: "Системный администратор",

        // Sidebar panel labels (по ролям)
        panel_root: "Панель супер-администратора",
        ...
        nav_logs: "Логи",
        nav_access: "КПП / Доступ",
        nav_soon: "Скоро",
        access_title: "Журнал доступа (КПП)",
        access_stat_entries: "Въезды",
        access_stat_exits: "Выезды",
        access_stat_guests: "Гости",
        access_stat_denied: "Отказы",
        access_date: "Дата",
        access_open: "Открыть",
        access_today: "Сегодня",
        access_refresh: "Обновить",
        access_search_plate: "Поиск номера...",
        access_th_plate: "Номер",
        access_th_dir: "Направление",
        access_th_status: "Статус",
        access_th_in: "Въезд",
        access_th_out: "Выезд",
        access_th_whom: "К кому",
        access_th_driver: "Водитель",
        access_th_doc: "Удостоверение",
        access_th_purpose: "Тип",
        access_th_source: "Источник",
        access_dir_in: "Въезд",
        access_dir_out: "Выезд",
        access_empty: "За эту дату записей нет",
        access_inside: "на территории",
        access_status_resident: "Резидент",
        access_status_guest: "Гость",
        access_status_blacklist: "Чёрный список",
        access_status_unknown: "Неизвестно",
        access_status_denied: "Отказано",
        access_src_camera: "Камера",
        access_src_manual: "Вручную",
        access_src_request: "Заявка",
        access_purpose_guest: "гость",
        access_purpose_delivery: "доставка",
        access_purpose_taxi: "такси",
        access_purpose_courier: "курьер",
        access_purpose_technician: "техник",
        nav_requests: "Заявки",
        ...
        nav_sales: "Продажи",
        sales_placeholder_title: "Модуль продаж вилл",
        sales_placeholder_desc: "Раздел для менеджеров по продаже домов и вилл комплекса. Структура будет доработана по плану: каталог объектов, статус сделок, клиенты, закреплённые менеджеры и отчёты.",
        sales_search_placeholder: "Поиск: ФИО, № дома, № договора",
        sales_new_contract: "Новый договор",
        sales_modal_new: "Новый договор",
        sales_modal_edit: "Договор",
        sales_col_type: "Тип",
        sales_col_number: "№ договора",
        sales_col_buyer: "Покупатель",
        sales_col_house: "Дом",
        sales_col_total: "Сумма, $",
        sales_col_status: "Статус",
        sales_col_created: "Создан",
        sales_status_all: "Все статусы",
        sales_status_DRAFT: "Черновик",
        sales_status_PENDING_APPROVAL: "Ожидает одобрения",
        sales_status_VIEWED: "Просмотрено",
        sales_status_APPROVED: "Одобрено",
        sales_status_REJECTED: "Отклонено",
        sales_status_PRINTED: "Распечатано",
        sales_type_FULL: "Полная оплата",
        sales_type_INSTALLMENT: "Рассрочка",
        sales_type_short_FULL: "ПОЛН.",
        sales_type_short_INSTALLMENT: "РАСС.",
        sales_section_header: "Шапка договора",
        sales_section_buyer: "Покупатель",
        sales_section_property: "Объект",
        sales_section_installment: "Рассрочка",
        sales_field_contract_number: "№ договора",
        sales_field_contract_date: "Дата договора",
        sales_field_contract_year: "Год",
        sales_field_city: "Город",
        sales_field_buyer_full_name: "ФИО покупателя *",
        sales_field_buyer_id_series: "Серия удостоверения",
        sales_field_buyer_id_number: "Номер удостоверения",
        sales_field_buyer_fin: "ФИН *",
        sales_field_buyer_phone: "Контактный номер",
        sales_field_buyer_email: "Электронная почта",
        sales_field_buyer_address: "Адрес",
        sales_field_house_number: "№ дома / виллы *",
        sales_field_area: "Площадь, м² *",
        sales_field_price_per_m2: "Цена за м², USD",
        sales_field_total_price: "Общая сумма, USD *",
        sales_total_autohint: "Автоматически = площадь × цена за м² (можно править вручную).",
        sales_field_initial: "Первоначальный взнос, USD *",
        sales_field_remaining: "Остаток, USD",
        sales_field_months: "Кол-во месяцев *",
        sales_field_monthly: "Ежемесячно, USD *",
        sales_monthly_autohint: "Автоматически = остаток / месяцы.",
        sales_schedule_title: "График платежей (Приложение №2)",
        sales_schedule_add: "Добавить строку",
        sales_schedule_month: "Месяц",
        sales_schedule_date: "Дата оплаты",
        sales_schedule_amount: "Сумма, USD",
        sales_schedule_hint: "Можно вручную редактировать. Кнопка «Автозаполнить» создаст строки на N месяцев от даты договора.",
        sales_schedule_autofill: "Автозаполнить",
        sales_request_approval: "Получить подтверждение",
        sales_print: "Распечатать",
        sales_approve: "Одобрить",
        sales_reject: "Отклонить",
        sales_save_draft: "Сохранить черновик",
        sales_indicator_waiting: "Отправлено — root ещё не просмотрел",
        sales_indicator_viewed: "Просмотрено root-ом, ожидается решение…",
        sales_indicator_approved: "Одобрено — можно печатать",
        sales_indicator_printed: "Одобрено и распечатано",
        sales_viewed_at: "просмотрен",
        sales_reviewed_at: "решение",
        sales_printed_at: "распечатан",
        sales_review_comment: "комментарий",
        sales_sent_for_approval: "Отправлено на одобрение",
        sales_approve_comment: "Комментарий (не обязательно):",
        sales_reject_comment: "Причина отказа:",
        sales_reject_comment_required: "Укажите причину отказа",
        common_ok: "OK",
        common_cancel: "Отмена",
        common_confirm: "Подтвердите действие",
        sales_approved_ok: "Договор одобрен",
        sales_rejected_ok: "Договор отклонён",
        sales_confirm_delete: "Удалить договор?",
        sales_confirm_delete_title: "Удаление договора",
        sales_no_contracts: "Договоров пока нет",
        sales_err_need_months: "Укажите кол-во месяцев",
        sales_err_not_approved: "Договор ещё не одобрен",
        sales_popup_blocked: "Разрешите всплывающие окна",
        notifications_contract_approval_title: "Договор на одобрение",
        notifications_contract_decision_title: "Решение по договору",
        notifications_contract_approval_template: "Договор №{number} (дом «{house}», покупатель «{buyer}») отправлен на одобрение менеджером {actor}.",
        notifications_contract_approved_template: "Договор №{number} ({buyer}) одобрен пользователем {actor}.",
        notifications_contract_rejected_template: "Договор №{number} ({buyer}) отклонён пользователем {actor}.",
        notifications_comment_tail: " Комментарий: {comment}",
        ...
        users_role_forbidden: "Недостаточно прав для создания этой роли",
        ...
        readings_serial: "Серийный номер",
        ...
        tariffs_use_consumption_multiplier_label: "Применять коэффициент к расходу",
        tariffs_consumption_multiplier_help: "Если включено, расход будет умножаться на коэффициент перед расчётом суммы.",
        ...
        payment_howto_step2: "Выберите способ оплаты: Royal Park Advance (аванс), кнопка «Оплатить» (Bank Card) или «Оплатить Apple Pay / Google Pay».",
        payment_howto_step3: "Проверьте сумму в блоке «Детали оплаты» и нажмите нужную кнопку оплаты. Далее вы будете перенаправлены на страницу AzeriCard, а результат отобразится в кабинете.",
        payment_method_advance: "Royal Park Advance",
        payment_method_card_portal: "Bank Card",
        payment_add_new_card: "Добавить новую",
        payment_card_payment: "Оплата через AzeriCard",
        payment_gateway_card_number: "AzeriCard",
        payment_gateway_card_label: "Банковская карта",
        payment_gateway_redirect: "Переход на страницу банка",
        ...
        payment_success_default: "Платёж успешно проведён!",
        payment_success_topup: "Пополнение аванса успешно выполнено.",
        payment_success_selected_lines: "Платёж применён к выбранным услугам. Излишек зачислен в аванс.",
        payment_success_selected_invoice: "Платёж успешно применён к выбранному счёту.",
        payment_success_not_applied_selected_invoice: "Платёж создан, но не применён к выбранному счёту.",
        payment_success_not_applied_any: "Платёж создан, но не применён к счетам (нет подходящих открытых счетов).",
        payment_success_applied_count: "Платёж успешно применён к {count} счёт(ам).",
        payment_success_created_not_applied: "Платёж создан, но не применён к счетам.",
        payment_success_advance_selected_lines: "Аванс применён к выбранным услугам.",
        ...
        user_nav_access: "Пропуск авто",
        payment_unavailable: "Недоступно",
        user_news_important: "Важно",
        access_tab_vehicles: "Мои авто",
        access_desc_vehicles: "шлагбаум открывается для них автоматически",
        access_desc_guests: "временный въезд для гостей и мастеров",
        access_desc_requests: "попросите КПП впустить или выпустить машину",
        access_tab_guests: "Гостевые пропуска",
        access_tab_requests: "Заявки охране",
        access_plate: "Номер",
        access_label: "Метка",
        access_add: "Добавить",
        access_from: "С",
        access_to: "До",
        access_create: "Создать",
        access_direction: "Направление",
        access_dir_in: "Впустить",
        access_dir_out: "Выпустить",
        access_note: "Комментарий",
        access_send: "Отправить охране",
        access_active: "активен",
        access_delete: "Удалить",
        access_limit_label: "Авто",
        access_no_vehicles: "Авто пока нет.",
        access_no_guests: "Гостевых пропусков пока нет.",
        access_no_requests: "Заявок пока нет.",
        access_expired: "истёк",
        access_req_handled: "выполнено",
        access_req_rejected: "отклонено",
        access_req_pending: "ожидает",
        access_need_window: "Укажите период действия",
        ...
        user_advance: "Аванс",
        user_advance_topup_hint: "Нажмите, чтобы пополнить баланс",
        user_advance_topup_hint_short: "Пополнить",
        ...
        user_advance_history_btn: "История списаний аванса",
        user_advance_history_title: "Куда ушёл аванс",
        user_nav_advance_history: "Списания аванса",
        user_nav_payment_history: "История платежей",
        user_payment_history_title: "История платежей",
        user_ph_total_confirmed: "Успешно",
        user_ph_total_topup: "Пополнения",
        user_ph_total_failed: "Неуспешно",
        user_ph_date_from: "С даты",
        user_ph_date_to: "По дату",
        user_ph_status: "Статус",
        user_ph_operation_type: "Тип операции",
        user_ph_payment_method: "Метод оплаты",
        user_ph_category: "Категория",
        user_ph_ref_order: "Order/Ref",
        user_ph_status_confirmed: "Подтвержден",
        user_ph_status_initiated: "В обработке",
        user_ph_status_declined: "Отклонен",
        user_ph_status_signature_failed: "Ошибка подписи",
        user_ph_type_invoice_payment: "Оплата счета",
        user_ph_type_advance_topup: "Пополнение аванса",
        user_ph_type_advance_writeoff: "Списание аванса",
        user_ph_method_bank_card: "Банковская карта",
        user_ph_method_wallet_combined: "Apple Pay/Google Pay",
        user_ph_method_cash: "Наличные",
        user_ph_method_transfer: "Перевод",
        user_ph_method_advance_internal: "Внутренний аванс",
        user_ph_category_utility: "Коммунальные",
        user_ph_category_maintenance: "Сервис",
        user_ph_category_advance: "Аванс",
        user_ph_detail_title: "Детали операции",
        user_ah_total_deducted: "Всего списано:",
        user_ah_th_date: "Дата",
        user_ah_th_invoice: "Счёт",
        user_ah_th_period: "Период",
        user_ah_th_type: "Тип",
        user_ah_th_amount: "Сумма",
        user_btn_pay_month: "Оплатить за месяц",
        user_no_current_month_invoice: "Счёт за текущий месяц не найден. Откройте раздел «Мои счета».",
        user_notice_title: "Уведомление",
    ...
    az: {
        ...
        pwsetup_title: "Şifrənin təyini",
        pwsetup_subtitle: "Hesabınız üçün yeni şifrə daxil edin",
        pwsetup_login_label: "Login",
        pwsetup_fullname_label: "Ad, soyad",
        pwsetup_fullname_ph: "Ad, soyadı daxil edin",
        pwsetup_phone_label: "Telefon",
        pwsetup_email_label: "E-mail",
        pwsetup_password_label: "Şifrə təyin edin",
        pwsetup_password_ph: "Ən azı 6 simvol",
        pwsetup_confirm_label: "Yeni şifrəni təkrarlayın",
        pwsetup_confirm_ph: "Şifrəni təkrarlayın",
        pwsetup_submit: "Təsdiq et",
        pwsetup_processing: "Emal olunur...",
        pwsetup_err_title: "Xəta",
        pwsetup_err_no_token: "Aktivləşdirmə tokeni yoxdur",
        pwsetup_back_home: "Ana səhifəyə qayıt",
        pwsetup_back_login: "Girişə qayıt",
        pwsetup_err_load: "İstifadəçi məlumatlarını almaq mümkün olmadı",
        pwsetup_err_unauth: "Avtorizasiya olunmamısınız",
        pwsetup_denied_title: "Giriş qadağandır",
        pwsetup_already_set: "Bu login üçün şifrə artıq təyin edilib.",
        pwsetup_go_login: "Girişə keç",
        pwsetup_err_fullname: "Ad, soyadı daxil edin",
        pwsetup_err_phone: "Telefonu daxil edin",
        pwsetup_err_email: "E-mail daxil edin",
        pwsetup_err_password_min: "Şifrə ən azı 6 simvol olmalıdır",
        ...
        payments_method_card: "Kart",
        payments_method_advance: "Avans",
        ...
        payments_export_date_from_required: "Eksport üçün \"Tarixdən\" sahəsində başlanğıc tarixini seçmək mütləqdir.",
        ...
        apartment: "Mənzil",
        blocks: "Blok",
        invoices_filter_year_placeholder: "Bütün illər",
        invoices_filter_month_placeholder: "1-12",
        payments_export_title: "Ödənişlər üzrə hesabat",
        payments_export_subtitle: "Royal Park - Mühasibatlıq üçün eksport",
        payments_export_generated: "Sənəd tərtib edilib",
        payments_export_filters: "Filterlər",
        payments_export_count: "Ödənişlərin sayı",
        payments_export_total: "Ümumi məbləğ",
        payments_export_services_block_title: "Xidmətlər üzrə ümumiləşdirmə",
        payments_export_services_header_service: "Xidmət",
        payments_export_services_header_count: "Ödənişlərin sayı",
        payments_export_services_header_amount: "Məbləğ",
        payments_export_services_no_data: "Məlumat yoxdur",
        payments_export_details_block_title: "Ödənişlərin detalları",
        payments_export_details_date: "Tarix",
        payments_export_details_resident: "Rezident",
        payments_export_details_tenant: "Sakin",
        payments_export_details_amount: "Məbləğ",
        payments_export_details_method: "Metod",
        payments_export_details_leftover: "Qalıq",
        payments_export_details_reference: "Link / Riferens",
        payments_export_details_invoice: "Invoice",
        payments_export_details_services_total: "Xidmətlər üzrə məbləğ",
        payments_export_details_no_data: "Eksport üçün məlumat yoxdur",
        payments_export_filters_resident: "Rezident",
        payments_export_filters_method: "Metod",
        payments_export_filters_period: "Dövr",
        payments_export_filters_search: "Axtarış",
        payments_export_filters_amount: "Məbləğ",
        payments_export_filters_allocated_only: "Yalnız bölüşdürülmüş ödənişlər",
        payments_export_filters_services: "Xidmətlər",
        invoices_block_label: "Blok («bloka görə» üçün)",
        invoices_select_block: "— blok seçin —",
        invoices_due_date_label: "Ödəmə tarixi (due date)",
        invoices_due_date_required: "Zəhmət olmasa, ödəmə tarixini seçin.",
        invoices_issue_by_block: "Bloka görə hesab tərtib et",
        invoices_issue_all: "Bütün hesabları tərtib et",
        invoices_issue_all_confirm: "Bütün hesabları tərtib etmək istədiyinizə əminsiniz?",
        ...
        invoices_export_period_from_required: "Eksport üçün \"Dövrədən\" sahəsində başlanğıc dövrünü seçmək mütləqdir.",
        ...
        invoices_export_title: "Hesablar üzrə hesabat",
        invoices_export_subtitle: "Royal Park — Uçot üçün eksport",
        invoices_export_column_period: "Dövr",
        invoices_export_column_block: "Blok",
        invoices_export_column_unit: "Mənzil №",
        invoices_export_column_resident_name: "Sakinin FİO su",
        invoices_export_column_resident_phone: "Sakinin telefonu",
        invoices_export_column_resident_code: "Rezident kodu",
        invoices_export_column_invoice_number: "İnvoys №",
        invoices_export_column_status: "Status",
        invoices_export_column_amount: "Hesablanıb",
        invoices_export_column_paid: "Ödənilib",
        invoices_export_column_remaining: "Qalıq",
        invoices_export_column_due_date: "Ödəniş müddəti",
        invoices_export_column_payment_method: "Ödəniş üsulu",
        invoices_export_column_lines: "Hesablanma tərkibi",
        invoices_export_column_remaining_by_services: "Xidmətlər üzrə qalıq",
        invoices_export_usage: "Sərfiyyat",
        invoices_export_previous_reading: "Əvvəlki göstərici",
        invoices_export_current_reading: "Cari göstərici",
        invoices_export_total: "Cəmi",
        invoices_export_vat: "ƏDV",
        invoices_export_utilities_net: "Kommunal (ƏDV-siz)",
        invoices_export_utilities_vat: "Kommunal ƏDV",
        invoices_export_utilities_with_vat: "Kommunal (ƏDV ilə)",
        invoices_export_service_total_label: "Ümumi",
        invoices_export_count_invoices: "Hesabların sayı",
        invoices_export_date_from: "Başlanğıc",
        invoices_export_date_to: "Bitmə",
        invoices_export_stable_tariff_electricity: "Sabit tarif (Elektrik)",
        invoices_export_stable_tariff_gas: "Sabit tarif (Qaz)",
        invoices_export_stable_tariff_water: "Sabit tarif (Su)",
        invoices_export_stable_tariff_sewerage: "Sabit tarif (Kanalizasiya)",
        invoices_export_stable_tariff: "Sabit tarif",
        invoices_export_sewerage: "Kanalizasiya",
        ...
        monthly_issue_confirm_title: "Bildiriş göndərişi",
        monthly_issue_confirm_message: "Bütün tərtib edilmiş hesablar üzrə istifadəçilərə bildiriş göndərilsin?",
        monthly_issue_confirm_due_date: "Bildirişdə ödəniş son tarixi: {date} (+{days} gün)",
        monthly_issue_success: "Bildirişlər uğurla göndərildi! Say: {count}",
        monthly_issue_error_prefix: "Xəta: {message}",
        ...
        nav_logs: "Loglar",
        nav_access: "KPP / Giriş-çıxış",
        nav_soon: "Tezliklə",
        access_title: "Giriş-çıxış jurnalı (KPP)",
        access_stat_entries: "Girişlər",
        access_stat_exits: "Çıxışlar",
        access_stat_guests: "Qonaqlar",
        access_stat_denied: "İmtinalar",
        access_date: "Tarix",
        access_open: "Aç",
        access_today: "Bu gün",
        access_refresh: "Yenilə",
        access_search_plate: "Nömrə axtar...",
        access_th_plate: "Nömrə",
        access_th_dir: "İstiqamət",
        access_th_status: "Status",
        access_th_in: "Giriş",
        access_th_out: "Çıxış",
        access_th_whom: "Kimə",
        access_th_driver: "Sürücü",
        access_th_doc: "Şəxsiyyət",
        access_th_purpose: "Növ",
        access_th_source: "Mənbə",
        access_dir_in: "Giriş",
        access_dir_out: "Çıxış",
        access_empty: "Bu tarixə qeyd yoxdur",
        access_inside: "ərazidə",
        access_status_resident: "Sakin",
        access_status_guest: "Qonaq",
        access_status_blacklist: "Qara siyahı",
        access_status_unknown: "Naməlum",
        access_status_denied: "İmtina",
        access_src_camera: "Kamera",
        access_src_manual: "Əl ilə",
        access_src_request: "Sorğu",
        access_purpose_guest: "qonaq",
        access_purpose_delivery: "çatdırılma",
        access_purpose_taxi: "taksi",
        access_purpose_courier: "kuryer",
        access_purpose_technician: "texnik",
        ...
        nav_sales: "Satışlar",
        sales_placeholder_title: "Villa satışları modulu",
        sales_placeholder_desc: "Kompleksin ev və villalarının satışı üzrə menecerlər üçün bölmə. Struktur plana uyğun olaraq inkişaf etdiriləcək: obyekt kataloqu, sövdələşmə statusu, müştərilər, məsul menecerlər və hesabatlar.",
        sales_search_placeholder: "Axtarış: A.S.A., ev №, müqavilə №",
        sales_new_contract: "Yeni müqavilə",
        sales_modal_new: "Yeni müqavilə",
        sales_modal_edit: "Müqavilə",
        sales_col_type: "Növ",
        sales_col_number: "Müqavilə №",
        sales_col_buyer: "Alıcı",
        sales_col_house: "Ev",
        sales_col_total: "Məbləğ, $",
        sales_col_status: "Status",
        sales_col_created: "Yaradılıb",
        sales_status_all: "Bütün statuslar",
        sales_status_DRAFT: "Qaralama",
        sales_status_PENDING_APPROVAL: "Təsdiq gözlənilir",
        sales_status_VIEWED: "Baxılıb",
        sales_status_APPROVED: "Təsdiqləndi",
        sales_status_REJECTED: "Rədd edildi",
        sales_status_PRINTED: "Çap edildi",
        sales_type_FULL: "Tam ödənişli",
        sales_type_INSTALLMENT: "Hissəli ödənişli",
        sales_type_short_FULL: "TAM",
        sales_type_short_INSTALLMENT: "HİSSƏLİ",
        sales_section_header: "Müqavilə başlığı",
        sales_section_buyer: "Alıcı",
        sales_section_property: "Obyekt (Yaşayış sahəsi)",
        sales_section_installment: "Hissəli ödəniş",
        sales_field_contract_number: "Müqavilə № (NN)",
        sales_field_contract_date: "Müqavilə tarixi",
        sales_field_contract_year: "İl",
        sales_field_city: "Şəhər",
        sales_field_buyer_full_name: "Alıcının A.S.A. *",
        sales_field_buyer_id_series: "Ş/V seriyası",
        sales_field_buyer_id_number: "Ş/V №",
        sales_field_buyer_fin: "FIN *",
        sales_field_buyer_phone: "Əlaqə nömrəsi",
        sales_field_buyer_email: "Elektron poçt",
        sales_field_buyer_address: "Ünvan",
        sales_field_house_number: "Ev / villa № *",
        sales_field_area: "Sahə, m² *",
        sales_field_price_per_m2: "m² qiyməti, USD",
        sales_field_total_price: "Ümumi məbləğ, USD *",
        sales_total_autohint: "Avtomatik = sahə × m² qiyməti (əl ilə dəyişilə bilər).",
        sales_field_initial: "İlkin ödəniş, USD *",
        sales_field_remaining: "Qalıq, USD",
        sales_field_months: "Ay sayı *",
        sales_field_monthly: "Aylıq ödəniş, USD *",
        sales_monthly_autohint: "Avtomatik = qalıq / ay sayı.",
        sales_schedule_title: "Ödəniş cədvəli (Əlavə №2)",
        sales_schedule_add: "Sətir əlavə et",
        sales_schedule_month: "Ay",
        sales_schedule_date: "Ödəniş tarixi",
        sales_schedule_amount: "Məbləğ, USD",
        sales_schedule_hint: "Əl ilə redaktə edilə bilər. «Avto-doldur» düyməsi N ay üçün sətirləri yaradacaq.",
        sales_schedule_autofill: "Avto-doldur",
        sales_request_approval: "Təsdiq al",
        sales_print: "Çap et",
        sales_approve: "Təsdiqlə",
        sales_reject: "Rədd et",
        sales_save_draft: "Qaralama kimi saxla",
        sales_indicator_waiting: "Göndərildi — root hələ baxmayıb",
        sales_indicator_viewed: "Root tərəfindən baxıldı, qərar gözlənilir…",
        sales_indicator_approved: "Təsdiqləndi — çap etmək olar",
        sales_indicator_printed: "Təsdiqləndi və çap edildi",
        sales_viewed_at: "baxıldı",
        sales_reviewed_at: "qərar",
        sales_printed_at: "çap edildi",
        sales_review_comment: "şərh",
        sales_sent_for_approval: "Təsdiq üçün göndərildi",
        sales_approve_comment: "Şərh (məcburi deyil):",
        sales_reject_comment: "İmtinanın səbəbi:",
        sales_reject_comment_required: "İmtina səbəbini göstərin",
        common_ok: "OK",
        common_cancel: "Ləğv et",
        common_confirm: "Əməliyyatı təsdiqləyin",
        sales_approved_ok: "Müqavilə təsdiqləndi",
        sales_rejected_ok: "Müqavilə rədd edildi",
        sales_confirm_delete: "Müqavilə silinsin?",
        sales_confirm_delete_title: "Müqavilənin silinməsi",
        sales_no_contracts: "Hələ müqavilə yoxdur",
        sales_err_need_months: "Ay sayını göstərin",
        sales_err_not_approved: "Müqavilə hələ təsdiqlənməyib",
        sales_popup_blocked: "Pop-up-lara icazə verin",
        notifications_contract_approval_title: "Təsdiq üçün müqavilə",
        notifications_contract_decision_title: "Müqavilə üzrə qərar",
        notifications_contract_approval_template: "№{number} müqaviləsi (ev «{house}», alıcı «{buyer}») menecer {actor} tərəfindən təsdiq üçün göndərildi.",
        notifications_contract_approved_template: "№{number} müqaviləsi ({buyer}) {actor} tərəfindən təsdiqləndi.",
        notifications_contract_rejected_template: "№{number} müqaviləsi ({buyer}) {actor} tərəfindən rədd edildi.",
        notifications_comment_tail: " Şərh: {comment}",
        ...
        users_role_forbidden: "Bu rolu yaratmaq üçün səlahiyyətiniz yoxdur",
        ...
        readings_month_from: "Ay (başlanğıc)",
        readings_month_to: "Ay (son)",
        ...
        readings_serial: "Seriya nömrəsi",
        ...
        tariffs_use_consumption_multiplier_label: "Sərfiyyata əmsal tətbiq et",
        tariffs_consumption_multiplier_help: "Aktiv olduqda, məbləğ hesablanmazdan əvvəl sərfiyyat əmsala vurulacaq.",
        ...
        user_nav_access: "Avto keçid",
        payment_unavailable: "Əlçatan deyil",
        user_news_important: "Vacib",
        access_tab_vehicles: "Avtomobillərim",
        access_desc_vehicles: "şlaqbaum onlar üçün avtomatik açılır",
        access_desc_guests: "qonaqlar və ustalar üçün müvəqqəti giriş",
        access_desc_requests: "KPP-dən maşını buraxmağı və ya çıxarmağı xahiş edin",
        access_tab_guests: "Qonaq keçidləri",
        access_tab_requests: "Mühafizəyə sorğu",
        access_plate: "Nömrə",
        access_label: "Etiket",
        access_add: "Əlavə et",
        access_from: "Başlanğıc",
        access_to: "Son",
        access_create: "Yarat",
        access_direction: "İstiqamət",
        access_dir_in: "Buraxmaq",
        access_dir_out: "Çıxarmaq",
        access_note: "Qeyd",
        access_send: "Mühafizəyə göndər",
        access_active: "aktiv",
        access_delete: "Sil",
        access_limit_label: "Avtomobil",
        access_no_vehicles: "Hələ avtomobil yoxdur.",
        access_no_guests: "Hələ qonaq keçidi yoxdur.",
        access_no_requests: "Hələ sorğu yoxdur.",
        access_expired: "vaxtı bitib",
        access_req_handled: "icra olundu",
        access_req_rejected: "rədd edildi",
        access_req_pending: "gözləyir",
        access_need_window: "Etibarlılıq müddətini göstərin",
        ...
        user_advance: "Avans",
        user_advance_topup_hint: "Balansı artırmaq üçün toxunun",
        user_advance_topup_hint_short: "Artır",
        ...
        user_advance_history_btn: "Avans silinmə tarixçəsi",
        user_advance_history_title: "Avans hara getdi",
        user_nav_advance_history: "Avans silinmələri",
        user_nav_payment_history: "Ödəmə tarixçəsi",
        user_payment_history_title: "Ödəmə tarixçəsi",
        user_ph_total_confirmed: "Uğurlu",
        user_ph_total_topup: "Artırmalar",
        user_ph_total_failed: "Uğursuz",
        user_ph_date_from: "Tarixdən",
        user_ph_date_to: "Tarixə qədər",
        user_ph_status: "Status",
        user_ph_operation_type: "Əməliyyat növü",
        user_ph_payment_method: "Ödəniş metodu",
        user_ph_category: "Kateqoriya",
        user_ph_ref_order: "Order/Ref",
        user_ph_status_confirmed: "Təsdiqlənib",
        user_ph_status_initiated: "Prosesdə",
        user_ph_status_declined: "Ləğv edildi",
        user_ph_status_signature_failed: "İmza xətası",
        user_ph_type_invoice_payment: "Hesab ödənişi",
        user_ph_type_advance_topup: "Avans artırma",
        user_ph_type_advance_writeoff: "Avans silinməsi",
        user_ph_method_bank_card: "Bank kartı",
        user_ph_method_wallet_combined: "Apple Pay/Google Pay",
        user_ph_method_cash: "Nağd",
        user_ph_method_transfer: "Köçürmə",
        user_ph_method_advance_internal: "Daxili avans",
        user_ph_category_utility: "Kommunal",
        user_ph_category_maintenance: "Xidmət",
        user_ph_category_advance: "Avans",
        user_ph_detail_title: "Əməliyyat detalları",
        user_ah_total_deducted: "Cəmi silinib:",
        user_ah_th_date: "Tarix",
        user_ah_th_invoice: "Hesab",
        user_ah_th_period: "Dövr",
        user_ah_th_type: "Növ",
        user_ah_th_amount: "Məbləğ",
        user_btn_pay_month: "Ay üçün ödə",
        user_no_current_month_invoice: "Cari ay üçün hesab tapılmadı. «Hesablarım» bölməsinə keçin.",
        user_notice_title: "Bildiriş",
        ...
        payment_howto_step2: "Ödəniş üsulunu seçin: Royal Park Advance (avans), «Ödə» düyməsi (Bank Card) və ya «Apple Pay / Google Pay ilə ödə».",
        payment_howto_step3: "«Ödəniş detalları» blokunda məbləği yoxlayın və uyğun ödəniş düyməsini basın. Sonra AzeriCard səhifəsinə yönləndiriləcəksiniz və nəticə kabinetdə göstəriləcək.",
        payment_method_advance: "Royal Park Advance",
        payment_method_card_portal: "Bank Card",
        payment_add_new_card: "Yeni əlavə et",
        payment_card_payment: "AzeriCard ilə ödəniş",
        payment_gateway_card_number: "AzeriCard",
        payment_gateway_card_label: "Bank kartı",
        payment_gateway_redirect: "Bank səhifəsinə keçid",
        ...
        payment_success_default: "Ödəniş uğurla tamamlandı!",
        payment_success_topup: "Avans artırılması uğurla tamamlandı.",
        payment_success_selected_lines: "Ödəniş seçilmiş xidmətlərə tətbiq edildi. Artıq məbləğ avansa köçürüldü.",
        payment_success_selected_invoice: "Ödəniş seçilmiş hesaba uğurla tətbiq edildi.",
        payment_success_not_applied_selected_invoice: "Ödəniş yaradıldı, lakin seçilmiş hesaba tətbiq edilmədi.",
        payment_success_not_applied_any: "Ödəniş yaradıldı, lakin hesablara tətbiq edilmədi (uyğun açıq hesab yoxdur).",
        payment_success_applied_count: "Ödəniş {count} hesab(lar)a uğurla tətbiq edildi.",
        payment_success_created_not_applied: "Ödəniş yaradıldı, lakin hesablara tətbiq edilmədi.",
        payment_success_advance_selected_lines: "Avans seçilmiş xidmətlərə tətbiq edildi.",
    ...
    en: {
        ...
        pwsetup_title: "Set password",
        pwsetup_subtitle: "Enter a new password for your account",
        pwsetup_login_label: "Login",
        pwsetup_fullname_label: "Full name",
        pwsetup_fullname_ph: "Enter full name",
        pwsetup_phone_label: "Phone",
        pwsetup_email_label: "E-mail",
        pwsetup_password_label: "Set a password",
        pwsetup_password_ph: "At least 6 characters",
        pwsetup_confirm_label: "Repeat the new password",
        pwsetup_confirm_ph: "Repeat the password",
        pwsetup_submit: "Confirm",
        pwsetup_processing: "Processing...",
        pwsetup_err_title: "Error",
        pwsetup_err_no_token: "Activation token is missing",
        pwsetup_back_home: "Back to home",
        pwsetup_back_login: "Back to login",
        pwsetup_err_load: "Failed to load user data",
        pwsetup_err_unauth: "You are not authorized",
        pwsetup_denied_title: "Access denied",
        pwsetup_already_set: "A password is already set for this login.",
        pwsetup_go_login: "Go to login",
        pwsetup_err_fullname: "Enter full name",
        pwsetup_err_phone: "Enter phone",
        pwsetup_err_email: "Enter email",
        pwsetup_err_password_min: "Password must be at least 6 characters",
        ...
        payments_method_card: "Card",
        payments_method_advance: "Advance",
        ...
        payments_export_date_from_required: "Please select a start date in the \"From\" field before exporting.",
        ...
        apartment: "Apartment",
        blocks: "Block",
        invoices_filter_year_placeholder: "All years",
        invoices_filter_month_placeholder: "1-12",
        payments_export_title: "Payments report",
        payments_export_subtitle: "Royal Park - Export for accounting",
        payments_export_generated: "Generated",
        payments_export_filters: "Filters",
        payments_export_count: "Number of payments",
        payments_export_total: "Total amount",
        payments_export_services_block_title: "Service summary",
        payments_export_services_header_service: "Service",
        payments_export_services_header_count: "Payments count",
        payments_export_services_header_amount: "Amount",
        payments_export_services_no_data: "No data",
        payments_export_details_block_title: "Payments details",
        payments_export_details_date: "Date",
        payments_export_details_resident: "Resident",
        payments_export_details_tenant: "Tenant",
        payments_export_details_amount: "Amount",
        payments_export_details_method: "Method",
        payments_export_details_leftover: "Remaining",
        payments_export_details_reference: "Link / Reference",
        payments_export_details_invoice: "Invoice",
        payments_export_details_services_total: "Amount by services",
        payments_export_details_no_data: "No data to export",
        payments_export_filters_resident: "Resident",
        payments_export_filters_method: "Method",
        payments_export_filters_period: "Period",
        payments_export_filters_search: "Search",
        payments_export_filters_amount: "Amount",
        payments_export_filters_allocated_only: "Only distributed payments",
        payments_export_filters_services: "Services",
        invoices_block_label: "Block (for «by block»)",
        invoices_select_block: "— select block —",
        invoices_due_date_label: "Due date",
        invoices_due_date_required: "Please select a due date.",
        invoices_issue_by_block: "Issue invoice by block",
        invoices_issue_all: "Issue all invoices",
        invoices_issue_all_confirm: "Are you sure you want to issue all invoices?",
        ...
        invoices_export_period_from_required: "Please select a start period in the \"Period from\" field before exporting.",
        ...
        invoices_export_title: "Invoice report",
        invoices_export_subtitle: "Royal Park — Export for accounting",
        invoices_export_column_period: "Period",
        invoices_export_column_block: "Block",
        invoices_export_column_unit: "Unit №",
        invoices_export_column_resident_name: "Resident full name",
        invoices_export_column_resident_phone: "Resident phone",
        invoices_export_column_resident_code: "Resident code",
        invoices_export_column_invoice_number: "Invoice №",
        invoices_export_column_status: "Status",
        invoices_export_column_amount: "Charged",
        invoices_export_column_paid: "Paid",
        invoices_export_column_remaining: "Remaining",
        invoices_export_column_due_date: "Due date",
        invoices_export_column_payment_method: "Payment method",
        invoices_export_column_lines: "Charge breakdown",
        invoices_export_column_remaining_by_services: "Remaining by services",
        invoices_export_usage: "Usage",
        invoices_export_previous_reading: "Previous reading",
        invoices_export_current_reading: "Current reading",
        invoices_export_total: "Total",
        invoices_export_vat: "VAT",
        invoices_export_utilities_net: "Utilities (excl. VAT)",
        invoices_export_utilities_vat: "Utilities VAT",
        invoices_export_utilities_with_vat: "Utilities (incl. VAT)",
        invoices_export_service_total_label: "Total",
        invoices_export_count_invoices: "Number of invoices",
        invoices_export_date_from: "From",
        invoices_export_date_to: "To",
        invoices_export_stable_tariff_electricity: "Stable tariff (Electricity)",
        invoices_export_stable_tariff_gas: "Stable tariff (Gas)",
        invoices_export_stable_tariff_water: "Stable tariff (Water)",
        invoices_export_stable_tariff_sewerage: "Stable tariff (Sewerage)",
        invoices_export_stable_tariff: "Stable tariff",
        invoices_export_sewerage: "Sewerage",
        ...
        monthly_issue_confirm_title: "Notification broadcast",
        monthly_issue_confirm_message: "Send notifications to users for all issued invoices?",
        monthly_issue_confirm_due_date: "Notification due date will be: {date} (+{days} days)",
        monthly_issue_success: "Notifications sent successfully! Count: {count}",
        monthly_issue_error_prefix: "Error: {message}",
        ...
        panel_root: "Super Admin Panel",
        panel_admin: "Admin Panel",
        panel_operator: "Operator Panel",
        ...
        nav_appeals: "Appeals",
        nav_logs: "Logs",
        nav_access: "Gate / Access",
        nav_soon: "Soon",
        access_title: "Access journal (Gate)",
        access_stat_entries: "Entries",
        access_stat_exits: "Exits",
        access_stat_guests: "Guests",
        access_stat_denied: "Denied",
        access_date: "Date",
        access_open: "Open",
        access_today: "Today",
        access_refresh: "Refresh",
        access_search_plate: "Search plate...",
        access_th_plate: "Plate",
        access_th_dir: "Direction",
        access_th_status: "Status",
        access_th_in: "Entry",
        access_th_out: "Exit",
        access_th_whom: "Visiting",
        access_th_driver: "Driver",
        access_th_doc: "ID",
        access_th_purpose: "Type",
        access_th_source: "Source",
        access_dir_in: "In",
        access_dir_out: "Out",
        access_empty: "No records for this date",
        access_inside: "on site",
        access_status_resident: "Resident",
        access_status_guest: "Guest",
        access_status_blacklist: "Blacklist",
        access_status_unknown: "Unknown",
        access_status_denied: "Denied",
        access_src_camera: "Camera",
        access_src_manual: "Manual",
        access_src_request: "Request",
        access_purpose_guest: "guest",
        access_purpose_delivery: "delivery",
        access_purpose_taxi: "taxi",
        access_purpose_courier: "courier",
        access_purpose_technician: "technician",
        ...
        nav_users: "Users",
        nav_sales: "Sales",
        sales_placeholder_title: "Villa sales module",
        sales_placeholder_desc: "Section for managers handling house and villa sales across the complex. The structure will evolve per plan: property catalogue, deal status, clients, assigned managers and reports.",
        sales_search_placeholder: "Search: buyer, house #, contract #",
        sales_new_contract: "New contract",
        sales_modal_new: "New contract",
        sales_modal_edit: "Contract",
        sales_col_type: "Type",
        sales_col_number: "Contract #",
        sales_col_buyer: "Buyer",
        sales_col_house: "House",
        sales_col_total: "Amount, $",
        sales_col_status: "Status",
        sales_col_created: "Created",
        sales_status_all: "All statuses",
        sales_status_DRAFT: "Draft",
        sales_status_PENDING_APPROVAL: "Awaiting approval",
        sales_status_VIEWED: "Viewed",
        sales_status_APPROVED: "Approved",
        sales_status_REJECTED: "Rejected",
        sales_status_PRINTED: "Printed",
        sales_type_FULL: "Full payment",
        sales_type_INSTALLMENT: "Installment",
        sales_type_short_FULL: "FULL",
        sales_type_short_INSTALLMENT: "INST.",
        sales_section_header: "Contract header",
        sales_section_buyer: "Buyer",
        sales_section_property: "Property",
        sales_section_installment: "Installment plan",
        sales_field_contract_number: "Contract # (NN)",
        sales_field_contract_date: "Contract date",
        sales_field_contract_year: "Year",
        sales_field_city: "City",
        sales_field_buyer_full_name: "Buyer full name *",
        sales_field_buyer_id_series: "ID series",
        sales_field_buyer_id_number: "ID number",
        sales_field_buyer_fin: "FIN *",
        sales_field_buyer_phone: "Phone",
        sales_field_buyer_email: "Email",
        sales_field_buyer_address: "Address",
        sales_field_house_number: "House / villa # *",
        sales_field_area: "Area, m² *",
        sales_field_price_per_m2: "Price per m², USD",
        sales_field_total_price: "Total price, USD *",
        sales_total_autohint: "Auto = area × price per m² (manual edits allowed).",
        sales_field_initial: "Down payment, USD *",
        sales_field_remaining: "Remaining, USD",
        sales_field_months: "Months *",
        sales_field_monthly: "Monthly, USD *",
        sales_monthly_autohint: "Auto = remaining / months.",
        sales_schedule_title: "Payment schedule (Appendix №2)",
        sales_schedule_add: "Add row",
        sales_schedule_month: "Month",
        sales_schedule_date: "Payment date",
        sales_schedule_amount: "Amount, USD",
        sales_schedule_hint: "Editable manually. “Auto-fill” creates rows for N months from the contract date.",
        sales_schedule_autofill: "Auto-fill",
        sales_request_approval: "Request approval",
        sales_print: "Print",
        sales_approve: "Approve",
        sales_reject: "Reject",
        sales_save_draft: "Save draft",
        sales_indicator_waiting: "Sent — root has not viewed yet",
        sales_indicator_viewed: "Viewed by root, awaiting decision…",
        sales_indicator_approved: "Approved — ready to print",
        sales_indicator_printed: "Approved and printed",
        sales_viewed_at: "viewed",
        sales_reviewed_at: "decision",
        sales_printed_at: "printed",
        sales_review_comment: "comment",
        sales_sent_for_approval: "Sent for approval",
        sales_approve_comment: "Comment (optional):",
        sales_reject_comment: "Reason for rejection:",
        sales_reject_comment_required: "Please specify the rejection reason",
        common_ok: "OK",
        common_cancel: "Cancel",
        common_confirm: "Please confirm the action",
        sales_approved_ok: "Contract approved",
        sales_rejected_ok: "Contract rejected",
        sales_confirm_delete: "Delete contract?",
        sales_confirm_delete_title: "Delete contract",
        sales_no_contracts: "No contracts yet",
        sales_err_need_months: "Specify the number of months",
        sales_err_not_approved: "Contract is not approved yet",
        sales_popup_blocked: "Please allow pop-ups",
        notifications_contract_approval_title: "Contract awaiting approval",
        notifications_contract_decision_title: "Contract decision",
        notifications_contract_approval_template: "Contract #{number} (house «{house}», buyer «{buyer}») was submitted for approval by manager {actor}.",
        notifications_contract_approved_template: "Contract #{number} ({buyer}) was approved by {actor}.",
        notifications_contract_rejected_template: "Contract #{number} ({buyer}) was rejected by {actor}.",
        notifications_comment_tail: " Comment: {comment}",
        ...
        users_role_forbidden: "You don't have permission to create this role",
        ...
        tariffs_use_consumption_multiplier_label: "Apply consumption multiplier",
        tariffs_consumption_multiplier_help: "When enabled, consumption is multiplied by this coefficient before amount calculation.",
        ...
        user_nav_access: "Vehicle pass",
        payment_unavailable: "Unavailable",
        user_news_important: "Important",
        access_tab_vehicles: "My vehicles",
        access_desc_vehicles: "the barrier opens for them automatically",
        access_desc_guests: "temporary entry for guests and workers",
        access_desc_requests: "ask the gate to let a car in or out",
        access_tab_guests: "Guest passes",
        access_tab_requests: "Requests to guards",
        access_plate: "Plate",
        access_label: "Label",
        access_add: "Add",
        access_from: "From",
        ...
        access_dir_in: "Let in",
        access_dir_out: "Let out",
        access_note: "Note",
        access_send: "Send to guards",
        access_active: "active",
        access_delete: "Delete",
        access_limit_label: "Vehicles",
        access_no_vehicles: "No vehicles yet.",
        access_no_guests: "No guest passes yet.",
        access_no_requests: "No requests yet.",
        access_expired: "expired",
        access_req_handled: "done",
        access_req_rejected: "rejected",
        access_req_pending: "pending",
        access_need_window: "Specify the validity window",
        ...
        user_advance_topup_hint: "Tap to top up balance",
        user_advance_topup_hint_short: "Top up",
        ...
        user_advance_history_btn: "Advance deduction history",
        user_advance_history_title: "Where advance was applied",
        user_nav_advance_history: "Advance deductions",
        user_nav_payment_history: "Payment history",
        user_payment_history_title: "Payment history",
        user_ph_total_confirmed: "Confirmed",
        user_ph_total_topup: "Top-ups",
        user_ph_total_failed: "Failed",
        user_ph_date_from: "From date",
        user_ph_date_to: "To date",
        user_ph_status: "Status",
        user_ph_operation_type: "Operation type",
        user_ph_payment_method: "Payment method",
        user_ph_category: "Category",
        user_ph_ref_order: "Order/Ref",
        user_ph_status_confirmed: "Confirmed",
        user_ph_status_initiated: "Initiated",
        user_ph_status_declined: "Declined",
        user_ph_status_signature_failed: "Signature failed",
        user_ph_type_invoice_payment: "Invoice payment",
        user_ph_type_advance_topup: "Advance top-up",
        user_ph_type_advance_writeoff: "Advance write-off",
        user_ph_method_bank_card: "Bank card",
        user_ph_method_wallet_combined: "Apple Pay/Google Pay",
        user_ph_method_cash: "Cash",
        user_ph_method_transfer: "Transfer",
        user_ph_method_advance_internal: "Internal advance",
        user_ph_category_utility: "Utility",
        user_ph_category_maintenance: "Maintenance",
        user_ph_category_advance: "Advance",
        user_ph_detail_title: "Operation details",
        user_ah_total_deducted: "Total deducted:",
        user_ah_th_date: "Date",
        user_ah_th_invoice: "Invoice",
        user_ah_th_period: "Period",
        user_ah_th_type: "Type",
        user_ah_th_amount: "Amount",
        user_btn_pay_month: "Pay for month",
        user_no_current_month_invoice: "No invoice found for the current month. Open My bills.",
        user_notice_title: "Notice",
        ...
        payment_howto_step2: "Choose a method: Royal Park Advance balance, «Pay» (Bank Card), or «Pay with Apple Pay / Google Pay».",
        payment_howto_step3: "Check the amount in «Payment details» and press the appropriate payment button. Then you will be redirected to AzeriCard and the result will appear in your cabinet.",
        payment_method_advance: "Royal Park Advance",
        payment_method_card_portal: "Bank Card",
        payment_add_new_card: "Add new",
        payment_card_payment: "Pay via AzeriCard",
        payment_gateway_card_number: "AzeriCard",
        payment_gateway_card_label: "Bank card",
        payment_gateway_redirect: "Redirect to bank page",
        ...
        payment_success_default: "Payment completed successfully!",
        payment_success_topup: "Advance top-up completed successfully.",
        payment_success_selected_lines: "Payment was applied to selected services. Excess amount moved to advance.",
        payment_success_selected_invoice: "Payment was successfully applied to the selected invoice.",
        payment_success_not_applied_selected_invoice: "Payment was created but not applied to the selected invoice.",
        payment_success_not_applied_any: "Payment was created but not applied to invoices (no suitable open invoices).",
        payment_success_applied_count: "Payment was successfully applied to {count} invoice(s).",
        payment_success_created_not_applied: "Payment was created but not applied to invoices.",
        payment_success_advance_selected_lines: "Advance was applied to selected services.",
    ...
    applyLanguage(lang) {
        ...
        container.querySelectorAll('td[data-period-month][data-period-year]').forEach(element => {
            ...
            if (month && year) {
                ...
                // Opening-debt invoices intentionally live in year 1900 (FIFO
                // pays them first) — keep the human label, not "Yanvar 1900"
                element.textContent = parseInt(year) <= 1901
                    ? (this.translate('invoice_opening_debt', lang) || 'Начальный долг')
                    : `${monthName} ${year}`;
            }
        });
